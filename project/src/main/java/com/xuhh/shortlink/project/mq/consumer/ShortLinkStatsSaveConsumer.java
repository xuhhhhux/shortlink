...
import com.xuhh.shortlink.project.mq.producer.DelayShortLinkStatsProducer;
...
import static com.xuhh.shortlink.project.common.constant.RedisConstant.LOCK_GID_UPDATE_KEY;
...
public class ShortLinkStatsSaveConsumer implements StreamListener<String, MapRecord<String, String, String>> {
    ...
    public void onMessage(MapRecord<String, String, String> message) {
        ...
        if (!messageQueueIdempotentHandler.isMessageProceed(id.toString())) {
            if (messageQueueIdempotentHandler.isMessageProceed(id.toString())) {
                return;
            }
        ...
        try {
            ...
            messageQueueIdempotentHandler.delMessageProceed(id.toString());
            log.error("短链接监控消息队列消费出现异常: {}", ex.getMessage());
        }
        messageQueueIdempotentHandler.setFinish(id.toString());
    }
