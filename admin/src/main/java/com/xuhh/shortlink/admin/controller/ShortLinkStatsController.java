...
import com.xuhh.shortlink.admin.remote.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
import com.xuhh.shortlink.admin.remote.dto.req.ShortLinkGroupStatsReqDTO;
import com.xuhh.shortlink.admin.remote.dto.req.ShortLinkStatsAccessRecordReqDTO;
import com.xuhh.shortlink.admin.remote.dto.req.ShortLinkStatsReqDTO;
import com.xuhh.shortlink.admin.remote.dto.resp.ShortLinkStatsAccessRecordRespDTO;
...
public class ShortLinkStatsController {
    ...
    public Result<ShortLinkStatsRespDTO> shortLinkStats(ShortLinkStatsReqDTO requestParam) {
        return shortLinkActualRemoteService.oneShortLinkStats(requestParam.getFullShortUrl(),
                requestParam.getGid(),
    ...
    public Result<Page<ShortLinkStatsAccessRecordRespDTO>> shortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
        return shortLinkActualRemoteService.shortLinkStatsAccessRecord(requestParam.getFullShortUrl(),
                requestParam.getGid(),
                requestParam.getStartDate(),
                requestParam.getEndDate());
    }
    ...
    public Result<Page<ShortLinkStatsAccessRecordRespDTO>> groupShortLinkStatsAccessRecord(ShortLinkGroupStatsAccessRecordReqDTO requestParam) {
        return shortLinkActualRemoteService.groupShortLinkStatsAccessRecord(requestParam.getGid(),
                requestParam.getStartDate(),
                requestParam.getEndDate());
    }
}
